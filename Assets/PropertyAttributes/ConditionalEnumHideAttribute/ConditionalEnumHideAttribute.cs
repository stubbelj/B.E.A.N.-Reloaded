...
public class ConditionalEnumHideAttribute : PropertyAttribute
{
    ...
    public ConditionalEnumHideAttribute(string conditionalSourceField, int enumValue1, bool _inverse = false)
    {
    ...
    public ConditionalEnumHideAttribute(string conditionalSourceField, int enumValue1, int enumValue2, bool _inverse = false)
    {
        this.ConditionalSourceField = conditionalSourceField;
        this.EnumValue1 = enumValue1;
